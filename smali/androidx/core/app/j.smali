...
.field private final c:Landroidx/core/app/i$c;
...
.method constructor <init>(Landroidx/core/app/i$c;)V
    ...
    .line 4
    iput-object p1, p0, Landroidx/core/app/j;->c:Landroidx/core/app/i$c;

    .line 5
    iget-object v0, p1, Landroidx/core/app/i$c;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Landroidx/core/app/i$c;->a:Landroid/content/Context;

    iget-object v4, p1, Landroidx/core/app/i$c;->L:Ljava/lang/String;
    ...
    .line 9
    :goto_0
    iget-object v2, p1, Landroidx/core/app/i$c;->U:Landroid/app/Notification;
    ...
    iget-object v5, p1, Landroidx/core/app/i$c;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Landroidx/core/app/i$c;->e:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroidx/core/app/i$c;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroidx/core/app/i$c;->k:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Landroidx/core/app/i$c;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/i$c;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Landroidx/core/app/i$c;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Landroidx/core/app/i$c;->l:I
    ...
    iget v4, p1, Landroidx/core/app/i$c;->u:I

    iget v9, p1, Landroidx/core/app/i$c;->v:I

    iget-boolean v10, p1, Landroidx/core/app/i$c;->w:Z
    ...
    iget-object v8, p1, Landroidx/core/app/i$c;->r:Ljava/lang/CharSequence;
    ...
    iget-boolean v8, p1, Landroidx/core/app/i$c;->o:Z
    ...
    .line 35
    :cond_6
    iget-object v0, p1, Landroidx/core/app/i$c;->E:Landroid/os/Bundle;
    ...
    .line 38
    iget-boolean v0, p1, Landroidx/core/app/i$c;->A:Z
    ...
    .line 40
    :cond_8
    iget-object v0, p1, Landroidx/core/app/i$c;->x:Ljava/lang/String;
    ...
    .line 42
    iget-boolean v0, p1, Landroidx/core/app/i$c;->y:Z
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, Landroidx/core/app/i$c;->z:Ljava/lang/String;
    ...
    .line 47
    :cond_b
    iget-object v0, p1, Landroidx/core/app/i$c;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/j;->d:Landroid/widget/RemoteViews;

    .line 48
    iget-object v0, p1, Landroidx/core/app/i$c;->J:Landroid/widget/RemoteViews;
    ...
    iget-boolean v9, p1, Landroidx/core/app/i$c;->n:Z
    ...
    .line 51
    iget-object v8, p1, Landroidx/core/app/i$c;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Landroidx/core/app/j;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Landroidx/core/app/i$c;->X:Ljava/util/ArrayList;
    ...
    iget-boolean v8, p1, Landroidx/core/app/i$c;->y:Z
    ...
    iget v8, p1, Landroidx/core/app/i$c;->G:I
    ...
    iget-object v8, p1, Landroidx/core/app/i$c;->H:Landroid/app/Notification;
    ...
    iget-object v3, p1, Landroidx/core/app/i$c;->X:Ljava/util/ArrayList;
    ...
    .line 67
    :cond_10
    iget-object v0, p1, Landroidx/core/app/i$c;->X:Ljava/util/ArrayList;
    ...
    .line 71
    :cond_11
    iget-object v0, p1, Landroidx/core/app/i$c;->K:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroidx/core/app/j;->i:Landroid/widget/RemoteViews;

    .line 72
    iget-object v0, p1, Landroidx/core/app/i$c;->d:Ljava/util/ArrayList;
    ...
    .line 73
    invoke-virtual {p1}, Landroidx/core/app/i$c;->d()Landroid/os/Bundle;
    ...
    .line 77
    :goto_9
    iget-object v11, p1, Landroidx/core/app/i$c;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Landroidx/core/app/i$c;->d:Ljava/util/ArrayList;
    ...
    .line 87
    iget-object v3, p1, Landroidx/core/app/i$c;->W:Landroid/graphics/drawable/Icon;
    ...
    iget-object v8, p1, Landroidx/core/app/i$c;->E:Landroid/os/Bundle;

    invoke-virtual {v3, v8}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v8, p1, Landroidx/core/app/i$c;->t:[Ljava/lang/CharSequence;
    ...
    .line 91
    iget-object v3, p1, Landroidx/core/app/i$c;->I:Landroid/widget/RemoteViews;
    ...
    .line 93
    :cond_16
    iget-object v3, p1, Landroidx/core/app/i$c;->J:Landroid/widget/RemoteViews;
    ...
    .line 95
    :cond_17
    iget-object v3, p1, Landroidx/core/app/i$c;->K:Landroid/widget/RemoteViews;
    ...
    iget-object v9, p1, Landroidx/core/app/i$c;->N:Ljava/lang/String;
    ...
    iget-wide v9, p1, Landroidx/core/app/i$c;->P:J
    ...
    iget-boolean v9, p1, Landroidx/core/app/i$c;->B:Z

    invoke-virtual {v8, v9}, Landroid/app/Notification$Builder;->setColorized(Z)Landroid/app/Notification$Builder;

    .line 104
    :cond_19
    iget-object v8, p1, Landroidx/core/app/i$c;->L:Ljava/lang/String;
    ...
    iget-boolean v7, p1, Landroidx/core/app/i$c;->S:Z
    ...
    iget-object v7, p1, Landroidx/core/app/i$c;->T:Landroidx/core/app/i$b;

    .line 114
    invoke-static {v7}, Landroidx/core/app/i$b;->a(Landroidx/core/app/i$b;)Landroid/app/Notification$BubbleMetadata;
    ...
    .line 116
    iget-object v4, p1, Landroidx/core/app/i$c;->O:Landroidx/core/content/b;
    ...
    .line 118
    iget v4, p1, Landroidx/core/app/i$c;->R:I
    ...
    .line 120
    :cond_1e
    iget-boolean p1, p1, Landroidx/core/app/i$c;->V:Z

    if-eqz p1, :cond_21

    .line 121
    iget-object p1, p0, Landroidx/core/app/j;->c:Landroidx/core/app/i$c;

    iget-boolean p1, p1, Landroidx/core/app/i$c;->y:Z
    ...
    iget-object p1, p1, Landroidx/core/app/i$c;->x:Ljava/lang/String;
...
.method private b(Landroidx/core/app/i$a;)V
    ...
    .line 25
    invoke-virtual {p1}, Landroidx/core/app/i$a;->l()Z
...
.method public c()Landroid/app/Notification;
    ...
    .line 1
    iget-object v0, p0, Landroidx/core/app/j;->c:Landroidx/core/app/i$c;

    iget-object v0, v0, Landroidx/core/app/i$c;->q:Landroidx/core/app/i$d;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0, p0}, Landroidx/core/app/i$d;->b(Landroidx/core/app/h;)V

    :cond_0
    if-eqz v0, :cond_1

    .line 3
    invoke-virtual {v0, p0}, Landroidx/core/app/i$d;->j(Landroidx/core/app/h;)Landroid/widget/RemoteViews;
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Landroidx/core/app/j;->c:Landroidx/core/app/i$c;

    iget-object v1, v1, Landroidx/core/app/i$c;->I:Landroid/widget/RemoteViews;
    ...
    .line 9
    invoke-virtual {v0, p0}, Landroidx/core/app/i$d;->i(Landroidx/core/app/h;)Landroid/widget/RemoteViews;
    ...
    .line 11
    iget-object v4, p0, Landroidx/core/app/j;->c:Landroidx/core/app/i$c;

    iget-object v4, v4, Landroidx/core/app/i$c;->q:Landroidx/core/app/i$d;

    .line 12
    invoke-virtual {v4, p0}, Landroidx/core/app/i$d;->k(Landroidx/core/app/h;)Landroid/widget/RemoteViews;

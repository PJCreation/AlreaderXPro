...
.method private a(Landroid/content/Context;La/g/j/e;)Landroidx/emoji2/text/f$c;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/j;-><init>(Landroid/content/Context;La/g/j/e;)V
...
.method private d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)La/g/j/e;
    .locals 3
    ...
    .line 5
    new-instance v1, La/g/j/e;

    const-string v2, "emojicompat-emoji-font"

    invoke-direct {v1, v0, p1, v2, p2}, La/g/j/e;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/f$c;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/e$a;->h(Landroid/content/Context;)La/g/j/e;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/e$a;->a(Landroid/content/Context;La/g/j/e;)Landroidx/emoji2/text/f$c;
...
.method h(Landroid/content/Context;)La/g/j/e;
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/e$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)La/g/j/e;
